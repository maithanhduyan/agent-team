...
- **Downstream:** T11 eval dataset builder → T12 GEPA runner + fitness
  ...
  dispatch sớm, TASK-8837 / Redmine #43; ADR-020):
  - **SÓNG 2a (đã tạo + dispatch 2026-09-01):** T11 (#44 / TASK-8866,
    backend — eval dataset builder; PR #32) · T14 (#45 / TASK-8867,
    tester — harness Windows Sandbox; PR #31). Điều kiện đạt: T09+T10
    approved (PR #19/#21 merged).
  - **SÓNG 2b (đã tạo + dispatch 2026-09-01 — TASK-9036 / Redmine #46):**
    T12 (#47 / TASK-9053, backend — GEPA runner + fitness gate, Python
    sidecar DSPy+GEPA, Node/TS tích hợp ADR-009/010, cost cap, judge đa
    model Q5 fallback DeepSeek) · T13 (#48 / TASK-9054, backend — skill
    evolved → branch → PR → human review, cấm auto-merge, cấm hot-swap,
    semantic preservation, size ≤ 15 KB, mỗi candidate ra branch riêng).
    Điều kiện đạt: T11 có PR #32 + T14 có PR #31.
  - **T15 (CHƯA tạo — vòng điều phối kế tiếp):** reviewer — review
    pipeline + các PR skill evolved (semantic preservation, size, diff
    quality, regression). Điều kiện tạo: **chỉ sau khi T12 (#47) và T13
    (#48) có PR** (bài học T07 — reviewer chỉ chạy khi có artifact).
