...
> **Task:** TASK-180 / Redmine #17 — BA: user stories and acceptance criteria
> for the skeleton (requirement ticket for the orchestrator TASK-178 skeleton)
...
| Artifact | Reference |
|---|---|
| Task | TASK-180 / Redmine #17 (BA user stories & acceptance criteria for the skeleton) |
...
| Redmine | Requirement ticket #17 + wiki page "Requirements" (see this PR) |
